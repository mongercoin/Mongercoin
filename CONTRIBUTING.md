Contributing to Monger Core
============================

The Monger Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Monger Core project, and is not to be
confused with overall Monger Network Protocol consensus changes.

Whether a pull request is merged into Monger Core rests with the project merge
...
Patches that change Monger consensus rules are considerably more involved than
...
Where a patch set proposes to change the Monger consensus, it must have been
...
The project leader is the release manager for each Monger Core release.
