...
/** Utility functions used by the Monger Qt UI.
 */
namespace GUIUtil
{
...
// Render Monger addresses in moMongerpace font
...
// Parse "Monger:" URI into recipient object, return true on successful parsing
