                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Monger Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Monger address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and Monger: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zMGR"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Monger Core"), this);
    aboutAction->setStatusTip(tr("Show information about Monger Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Monger"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Monger addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Monger addresses"));
    ...
    openInfoAction->setStatusTip(tr("Show diagMongertic information"));
    ...
    openAction->setStatusTip(tr("Open a Monger: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Monger Core help message to get a list with possible Monger command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Monger Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Monger network", "", count));
}
...
{
    QString strTitle = tr("Monger Core"); // default title
...
/** Creates context menu, its actions, and Mongers up all the relevant signals for mouse events. */
