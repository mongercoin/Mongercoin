                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received Monger from zMonger"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zMonger"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zMonger));
