...
QString TransactionTableModel::formatTxType(const TransactionRecord* wtx) const
{
    ...
    case TransactionRecord::ZerocoinMint:
        return tr("Converted Monger to zMonger");
    case TransactionRecord::ZerocoinSpend:
        return tr("Spent zMonger");
    case TransactionRecord::RecvFromZerocoinSpend:
        return tr("Received Monger from zMonger");
    case TransactionRecord::ZerocoinSpend_Change_zMonger:
        return tr("Minted Change as zMonger from zMonger Spend");
    case TransactionRecord::ZerocoinSpend_FromMe:
        return tr("Converted zMonger to Monger");
