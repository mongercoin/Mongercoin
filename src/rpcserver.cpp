...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Monger features */
        {"Monger", "masternode", &masternode, true, true, false},
        {"Monger", "listmasternodes", &listmasternodes, true, true, false},
        {"Monger", "getmasternodecount", &getmasternodecount, true, true, false},
        {"Monger", "masternodeconnect", &masternodeconnect, true, true, false},
        {"Monger", "masternodecurrent", &masternodecurrent, true, true, false},
        {"Monger", "masternodedebug", &masternodedebug, true, true, false},
        {"Monger", "startmasternode", &startmasternode, true, true, false},
        {"Monger", "createmasternodekey", &createmasternodekey, true, true, false},
        {"Monger", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"Monger", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"Monger", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"Monger", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"Monger", "getmasternodescores", &getmasternodescores, true, true, false},
        {"Monger", "mnbudget", &mnbudget, true, true, false},
        {"Monger", "preparebudget", &preparebudget, true, true, false},
        {"Monger", "submitbudget", &submitbudget, true, true, false},
        {"Monger", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"Monger", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"Monger", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"Monger", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"Monger", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"Monger", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"Monger", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"Monger", "checkbudgets", &checkbudgets, true, true, false},
        {"Monger", "mnsync", &mnsync, true, true, false},
        {"Monger", "spork", &spork, true, true, false},
        {"Monger", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"Monger", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use Mongerd, or the -server option to Monger-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> Monger-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:7120/\n";
}
