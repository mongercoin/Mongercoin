...
RESOURCES += src/qt/Monger.qrc src/qt/Monger_locale.qrc

TRANSLATIONS += src/qt/locale/Monger_bg.ts \
                src/qt/locale/Monger_de.ts \
                src/qt/locale/Monger_en.ts \
                src/qt/locale/Monger_es.ts \
                src/qt/locale/Monger_fi.ts \
                src/qt/locale/Monger_fr.ts \
                src/qt/locale/Monger_it.ts \
                src/qt/locale/Monger_ja.ts \
                src/qt/locale/Monger_pl.ts \
                src/qt/locale/Monger_pt.ts \
                src/qt/locale/Monger_ru.ts \
                src/qt/locale/Monger_sk.ts \
                src/qt/locale/Monger_sv.ts \
                src/qt/locale/Monger_vi.ts \
                src/qt/locale/Monger_zh_CN.ts \
                src/qt/locale/Monger_zh_TW.ts
