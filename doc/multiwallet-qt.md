...
In order to support loading of multiple wallets in Monger-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is Monger.cpp.
...
Changes to Monger.cpp
----------------------
Monger.cpp is the entry point into Monger-qt, and as such, will require some minor modifications to provide hooks for
